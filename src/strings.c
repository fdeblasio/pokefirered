...
const u8 gText_LightestMode[] = _("Lightest");
const u8 gText_SmallestMode[] = _("Smallest");
...
ALIGNED(4) const u8 gText_IDNumber[] = _("ID No.");
...
const u8 gText_DepositItem[] = _("Deposit Items");
...
const u8 gText_BillSPc[] = _("Bills's PC");
...
const u8 gText_PokeSum_PageName_PokemonSkills[] = _("Pokémon Stats");
...
const u8 gText_PokeSum_NextLv[] = _("Next Level");
