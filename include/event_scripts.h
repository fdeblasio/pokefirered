...
extern const u8 gNameChoice_Felix[];
extern const u8 gNameChoice_Jake[];
extern const u8 gNameChoice_Junya[];
extern const u8 gNameChoice_Mike[];
extern const u8 gNameChoice_Pat[];
extern const u8 gNameChoice_Rafael[];
...
extern const u8 gNameChoice_Emily[];
extern const u8 gNameChoice_Kim[];
